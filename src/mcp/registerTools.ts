...
import { AnswerQuestionInputSchema, answerQuestionTool } from "./tools/answerQuestion.js";
...
export function registerTools(server: McpServer): void {
  ...
  tool(server, "clearlane.answer_question", "Answer a natural-language transit reliability question with auditable data, action points, artifacts, and Mermaid.", AnswerQuestionInputSchema, answerQuestionTool);
